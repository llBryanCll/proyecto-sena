...
namespace ProyectoSenaLmour.Controllers
{
    public class HabitacionesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdHabitacion,NumeroHabitacion,TipoHabitacion,Estado")] Habitacione habitacion)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdHabitacion,NumeroHabitacion,TipoHabitacion,Estado")] Habitacione habitacion)
        {
